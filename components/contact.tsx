...
const ContactCom = () => {
    return (
        <div className="bg-[#0d1520] border border-[#1e2535] rounded-3xl py-2 px-4  max-w-xl mx-auto font-inter">
            <h2 className="font-syne text-xl font-black text-white mb-1">Contactez-nous</h2>
            ...
            {/* <p className="text-center text-[#3d4a5c] mt-3">
